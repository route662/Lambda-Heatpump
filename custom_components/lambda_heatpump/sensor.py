...
SENSORS = [
    ...
    {"name": "Heat Pump 1 Compressor Power Consumption Accumulated Total Increasing", "register": [1020, 1021], "unit": "Wh", "scale": 1, "precision": 0, "data_type": "int32", "device_class": "energy", "state_class": "total_increasing"},
    {"name": "Heat Pump 1 Compressor Thermal Energy Output Accumulated Total Increasing", "register": [1022, 1023], "unit": "Wh", "scale": 1, "precision": 0, "data_type": "int32", "device_class": "energy", "state_class": "total_increasing"},
